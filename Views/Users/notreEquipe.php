<?php $teamMembers = getTeamMembers($pdo); 
?>
    ...
    <div class="team-grid">
        ...
        <div class="team-member">
            <div class="member-photo">
                ...
                <img src="../../Assets/Photo-team/<?= $randomPhoto ?>.jpeg" alt="<?= htmlspecialchars($member['prenom'] . ' ' . $member['nom']); ?>">
            ...
            <div class="member-info">
                ...
                <div class="member-contact">
                    ...
                    <a href="tel:<?= htmlspecialchars($member['telephone']); ?>">
